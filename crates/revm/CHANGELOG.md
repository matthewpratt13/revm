...
## [20.0.0](https://github.com/matthewpratt13/revm/compare/revm-v19.2.0...revm-v20.0.0) - 2025-01-13
...
- fix eip3155 summary gas_used bug and add fork name ([#1216](https://github.com/matthewpratt13/revm/pull/1216))
...
- fix EthersDB deadlock ([#1089](https://github.com/matthewpratt13/revm/pull/1089))
...
- fix previous commit ([#1044](https://github.com/matthewpratt13/revm/pull/1044))
...
- fix typos in revm crate ([#821](https://github.com/matthewpratt13/revm/pull/821))
...
- fix revert from DestroyedChanged to DestroyedAgain ([#648](https://github.com/matthewpratt13/revm/pull/648))
...
- fix comment ([#529](https://github.com/matthewpratt13/revm/pull/529))
...
- fix web3db sanity check ([#245](https://github.com/matthewpratt13/revm/pull/245))
...
- Test l1 gas used fjord ([#1749](https://github.com/matthewpratt13/revm/pull/1749))
- Add test for `revm::optimism::L1BlockInfo::calculate_tx_l1_cost_fjord` ([#1743](https://github.com/matthewpratt13/revm/pull/1743))
...
- release (#1683)
- Add OP-Granite hardfork, limiting bn256Pairing input size ([#1685](https://github.com/matthewpratt13/revm/pull/1685))
...
- Use HandleOrRuntime to allow alloydb/ethersdb to hold a custom runtime ([#1576](https://github.com/matthewpratt13/revm/pull/1576))
...
- Removed .clone() in ExecutionHandler::call, and reusing output buffer in Interpreter ([#1512](https://github.com/matthewpratt13/revm/pull/1512))
...
- remove 'checked' bytecode bench causing benchmarks to crash due to name ([#1461](https://github.com/matthewpratt13/revm/pull/1461))
- cargo update (#1451)
- cleanup host blockhash fn (#1430)
- Revert "Revert "feat: implement EIP-2935 ([#1354](https://github.com/matthewpratt13/revm/pull/1354))" ([#1424](https://github.com/matthewpratt13/revm/pull/1424))" ([#1426](https://github.com/matthewpratt13/revm/pull/1426))
- Revert "feat: implement EIP-2935 ([#1354](https://github.com/matthewpratt13/revm/pull/1354))" ([#1424](https://github.com/matthewpratt13/revm/pull/1424))
- *(deps)* bump anyhow from 1.0.82 to 1.0.83 (#1404)
- remove alloydb example as the crate is not published (#1398)
- release (#1261)
- refactor lints (#1386)
- bump alloy & specify dep rev ([#1380](https://github.com/matthewpratt13/revm/pull/1380))
...
- Improve `EthersDB` ([#1208](https://github.com/matthewpratt13/revm/pull/1208))
- Revert "feat: optional nonce check ([#1195](https://github.com/matthewpratt13/revm/pull/1195))" ([#1212](https://github.com/matthewpratt13/revm/pull/1212))
- release (#1175)
- Change unwrap to ? to propagate errors ([#1207](https://github.com/matthewpratt13/revm/pull/1207))
- fix wonky test (#1197)
- clippy (#1196)
- *(deps)* bump anyhow from 1.0.80 to 1.0.81 (#1187)
- fix some typos (#1189)
- Update post_execution.rs ([#1180](https://github.com/matthewpratt13/revm/pull/1180))
...
- Check runtime dynamically ([#1135](https://github.com/matthewpratt13/revm/pull/1135))
- *(deps)* bump auto_impl from 1.1.2 to 1.2.0 (#1132)
- Add `db` and `db_mut` to evm ([#1133](https://github.com/matthewpratt13/revm/pull/1133))
- add ToString for no_std add exports some types in no_std (#1128)
- Add `clone` method to `ContextWithHandlerCfg` ([#1127](https://github.com/matthewpratt13/revm/pull/1127))
- remove unused EvmInstructionTables type alias (#1123)
- release tag v30 revm v6.1.0 (#1100)
- Ensure `L1Block` is in the cache ([#1121](https://github.com/matthewpratt13/revm/pull/1121))
- Fix feature name for generate_block_traces example ([#1120](https://github.com/matthewpratt13/revm/pull/1120))
- *(refactor)* Propagate fatal error (#1116)
- Revert "fix EthersDB deadlock ([#1089](https://github.com/matthewpratt13/revm/pull/1089))" ([#1118](https://github.com/matthewpratt13/revm/pull/1118))
- Remove DatabaseRef bound on CacheDB ([#1113](https://github.com/matthewpratt13/revm/pull/1113))
- clippy cleanup (#1112)
...
- Add memory offset ([#1032](https://github.com/matthewpratt13/revm/pull/1032))
...
- Remove preserve_order in serde_json ([#997](https://github.com/matthewpratt13/revm/pull/997))
...
- set deduct_caller in optimism handler ([#988](https://github.com/matthewpratt13/revm/pull/988))
...
- bump k256 and use normalize_s ([#870](https://github.com/matthewpratt13/revm/pull/870))
- simplify use statements (#864)
- Fix error message for LackOfFundForMaxFee ([#858](https://github.com/matthewpratt13/revm/pull/858))
...
- Instruction table ([#759](https://github.com/matthewpratt13/revm/pull/759))
- getter for  field of ([#792](https://github.com/matthewpratt13/revm/pull/792))
- Shared memory between calls ([#673](https://github.com/matthewpratt13/revm/pull/673))
- Fix typos (#790)
- *(deps)* bump tokio from 1.32.0 to 1.33.0 (#785)
- Use upstream create and create2 implementations ([#775](https://github.com/matthewpratt13/revm/pull/775))
- reorder JournalState impl (#772)
- document everything, dedup existing docs (#741)
- bump v26 revm v3.5.0 ([#765](https://github.com/matthewpratt13/revm/pull/765))
- document non-zero amounts in State::increment_balances (#760)
- tag v25, revm v3.4.0 (#755)
- Improve wording and fix typos ([#749](https://github.com/matthewpratt13/revm/pull/749))
...
- make BundleBuilder publicly available ([#729](https://github.com/matthewpratt13/revm/pull/729))
- *(perf)* only recalc code hash if its the default (#716)
- add warning on panic conditions in take_bundle (#715)
- Never inline the prepare functions ([#712](https://github.com/matthewpratt13/revm/pull/712))
...
- bundle size hint ([#670](https://github.com/matthewpratt13/revm/pull/670))
- deprecate `RefDBWrapper` (#696)
- expose StateDBBox (#694)
- *(state)* Make Database more generic. (#687)
- nits and renamings (#684)
- apply builder pattern for BundleState initialization ([#649](https://github.com/matthewpratt13/revm/pull/649))
- impl Eq, PartialEq for TransitionState (#677)
- Removed the last dependencies breaking no-std build. ([#669](https://github.com/matthewpratt13/revm/pull/669))
...
- add value parameter to Inspector::selfdestruct ([#645](https://github.com/matthewpratt13/revm/pull/645))
...
- book workflow ([#537](https://github.com/matthewpratt13/revm/pull/537))
- *(state)* bundle reverts collapse (#626)
- Revert "feat: alloy migration ([#535](https://github.com/matthewpratt13/revm/pull/535))" ([#616](https://github.com/matthewpratt13/revm/pull/616))
...
- clippy and fmt (#568)
- optimize stack usage for recursive `call` and `create` programs ([#522](https://github.com/matthewpratt13/revm/pull/522))
- consume all gas on invalid opcode ([#500](https://github.com/matthewpratt13/revm/pull/500))
...
- Bump v24, revm v3.3.0 ([#476](https://github.com/matthewpratt13/revm/pull/476))
- *(deps)* bump tokio from 1.27.0 to 1.28.0 (#470)
- *(deps)* bump anyhow from 1.0.70 to 1.0.71 (#471)
- add example to revm crate ([#468](https://github.com/matthewpratt13/revm/pull/468))
- Release v23, revm v3.2.0 ([#464](https://github.com/matthewpratt13/revm/pull/464))
- Release v22, revm v3.1.1 ([#460](https://github.com/matthewpratt13/revm/pull/460))
- typos (#448)
- v21, revm v3.1.0 (#444)
- bump all
- ethers to v2.0
- Improve EthersDB::new ([#440](https://github.com/matthewpratt13/revm/pull/440))
- add feature for ignoring base fee check ([#436](https://github.com/matthewpratt13/revm/pull/436))
...
- impl NonceTooHigh/ NonceTooLow checks ([#383](https://github.com/matthewpratt13/revm/pull/383))
- fix compilation if serde not enabled (#381)
- add no_std to primitives ([#366](https://github.com/matthewpratt13/revm/pull/366))
...
- Use gas price in place of effective gas price for initial balance check ([#359](https://github.com/matthewpratt13/revm/pull/359))
- revm-precompiles to revm-precompile
- Bump v20, changelog ([#350](https://github.com/matthewpratt13/revm/pull/350))
- Cleanup imports ([#348](https://github.com/matthewpratt13/revm/pull/348))
- add logs & return value to revert (#343)
- includes to libs (#338)
- Creating revm-primitives, revm better errors and db components  ([#334](https://github.com/matthewpratt13/revm/pull/334))
- mark `with-serde` feature as deprecated (#328)
- add Eq to AccountState (#326)
- make load_account pub ([#325](https://github.com/matthewpratt13/revm/pull/325))
- Cleanup, move hot fields toggether in Interpreter ([#321](https://github.com/matthewpratt13/revm/pull/321))
- *(deps)* bump tokio from 1.22.0 to 1.23.0 (#284)
- remove --all-features from tests bcs of gas calc gets disabled ([#291](https://github.com/matthewpratt13/revm/pull/291))
- Integer overflow while calculating the remaining gas in GasInspector (#287)
- native bits ([#278](https://github.com/matthewpratt13/revm/pull/278))
- *(release)* Bump revm and precompiles versions
- Bump primitive_types. Add statetest spec
- Bump revm to v2.3.0
- disable gas refunds with env flag ([#267](https://github.com/matthewpratt13/revm/pull/267))
- Export StorageSlot ([#265](https://github.com/matthewpratt13/revm/pull/265))
- Remove unused parking_lot dependency ([#244](https://github.com/matthewpratt13/revm/pull/244))
...
- Borrow self and add derive traits for OpCode ([#231](https://github.com/matthewpratt13/revm/pull/231))
- Bump revm v2.1.0 ([#224](https://github.com/matthewpratt13/revm/pull/224))
- expose original value on storageslot (#216)
- revm bump v2.0.0, precompile bump v1.1.1 ([#212](https://github.com/matthewpratt13/revm/pull/212))
- Optimize gas calculation U256 to u64 ([#213](https://github.com/matthewpratt13/revm/pull/213))
- current_opcode fn and rename program_counter to instruction_pointer ([#211](https://github.com/matthewpratt13/revm/pull/211))
- Cfg choose create analysis, option on bytecode size limit ([#210](https://github.com/matthewpratt13/revm/pull/210))
- export create address calls (#209)
- Cargo sort. Bump lib versions ([#208](https://github.com/matthewpratt13/revm/pull/208))
- *(deps)* bump futures from 0.3.23 to 0.3.24 (#194)
- use Infallible for memory db's error type ([#196](https://github.com/matthewpratt13/revm/pull/196))
- reexport revm_precompiles as precompiles ([#197](https://github.com/matthewpratt13/revm/pull/197))
- Cache precompile hashmaps ([#192](https://github.com/matthewpratt13/revm/pull/192))
- Add support for old forks. ([#191](https://github.com/matthewpratt13/revm/pull/191))
- export JournaledState (#190)
- Revert "refactor(revm): use u64 for gas refund counter ([#180](https://github.com/matthewpratt13/revm/pull/180))" ([#187](https://github.com/matthewpratt13/revm/pull/187))
- *(revm)* use u64 for gas refund counter (#180)
- *(precompiles)* Vec -> BTreeMap (#177)
- *(deps)* bump futures from 0.3.21 to 0.3.23 (#173)
- Handle HighNonce tests ([#176](https://github.com/matthewpratt13/revm/pull/176))
- JournaledState ([#175](https://github.com/matthewpratt13/revm/pull/175))
- Update account storage methods in CacheDB (#171)
- Return `ExecutionResult`, which includes `gas_refunded` (#169)
- Optimize calldataload. Some cleanup ([#168](https://github.com/matthewpratt13/revm/pull/168))
- bump revm v1.9.0
- Bytecode hash, remove override_spec, ([#165](https://github.com/matthewpratt13/revm/pull/165))
- revm bump 1.8. update libs. snailtracer rename ([#159](https://github.com/matthewpratt13/revm/pull/159))
- bump revm_precompiles to v1.1.0
- bump revm to v1.7.0
- Byzantine to Byzantium ([#146](https://github.com/matthewpratt13/revm/pull/146))
- Make CacheDB fields pub ([#145](https://github.com/matthewpratt13/revm/pull/145))
- Update README
- bump revm 1.6.0, changelogs
- Introduce account Touched/Cleared/None state in CacheDB ([#140](https://github.com/matthewpratt13/revm/pull/140))
- Return specific `Return` statuses in `CALL`s ([#136](https://github.com/matthewpratt13/revm/pull/136))
- don't delete account and storage entries on commit ([#126](https://github.com/matthewpratt13/revm/pull/126))
- revm bump v1.5.0. Release notes
- enable EIP2200 in Istanbul ([#125](https://github.com/matthewpratt13/revm/pull/125))
- Consensus error with gas block for SSTORE stipend check ([#124](https://github.com/matthewpratt13/revm/pull/124))
- v9 release notes
...
- empty keccak constant and remove access_list.clone ([#111](https://github.com/matthewpratt13/revm/pull/111))
- typo fixes
- [revm] is_static for Inspector initialize_interp
- v6 changelog, bump versions
- add missing derives
- Rework analysis ([#89](https://github.com/matthewpratt13/revm/pull/89))
- Update AccountInfo#code documentation ([#94](https://github.com/matthewpratt13/revm/pull/94))
- Various fixes ([#93](https://github.com/matthewpratt13/revm/pull/93))
- remove untable fmt
- nit
- [revm] optimize is_push check
- turn off default features for zkp-u256 (#68)
- Bump futures from 0.3.17 to 0.3.21 ([#64](https://github.com/matthewpratt13/revm/pull/64))
- bump dependencies ([#63](https://github.com/matthewpratt13/revm/pull/63))
- Big Refactor. Machine to Interpreter. refactor instructions. call/create struct ([#52](https://github.com/matthewpratt13/revm/pull/52))
- provide default impl for inspector trait
- improve docs slightly
- document unsafe code in stack
- [revm] pop_top and unsafe comments ([#51](https://github.com/matthewpratt13/revm/pull/51))
- clippy
- Inspector fixup
...
- [revm][perf] Error refactor to Return ([#9](https://github.com/matthewpratt13/revm/pull/9))
